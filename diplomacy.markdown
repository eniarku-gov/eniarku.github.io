...
4. The foreign state has a meaningful digital and physical footprint that is well-documented, verifiable, and truthful.

## Diplomatic Inquiries
For diplomatic inquiries of any kind, submit the inquiry form below or contact the government directly via its official email address: [gov.eniarku@gmail.com](mailto:gov.eniarku@gmail.com). Please review the above requirements prior to submitting (all fields are required).

{% include diplomacy-form.html %}

<!--
<details class="diplomacy-collapsible">
    <summary class="diplomacy-collapsible-summary">
        Submit a diplomatic inquiry here.
    </summary>

    <div class="diplomacy-collapsible-content">
        {% include diplomacy-form.html %}
    </div>
</details>
-->